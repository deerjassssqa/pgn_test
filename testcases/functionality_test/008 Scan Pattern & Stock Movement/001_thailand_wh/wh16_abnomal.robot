...
WH16 RM
    3.3 : Sort RM WIP2 -> FG/SCRAP - Sort raw materials (RM) from WIP2 to finished goods (FG) or scrapped goods (SCRAP)    ${data_excel.WH16_TH_CHANGE_3_3[RM]}
    8 : DLV (Delivery) - Shipping from TMT Packing    ${data_excel.WH16_TH_DELIVERY_8[RM]}
