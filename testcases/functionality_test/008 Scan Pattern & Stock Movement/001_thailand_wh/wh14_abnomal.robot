...
WH14 RM
    3.2 : Sort RM WIP1 -> WIP2 - Sort raw materials (RM) from WIP1 to WIP2    ${data_excel.WH14_TH_CHANGE_3_2[RM]}
    8 : DLV (Delivery) - Shipping from TMT Packing    ${data_excel.WH14_TH_DELIVERY_8[RM]}
