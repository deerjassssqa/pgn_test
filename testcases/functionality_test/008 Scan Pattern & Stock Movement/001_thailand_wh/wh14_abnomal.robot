...
*** Test Cases ***
WH14 Delivery / DLV with Barcode / R-PACKAGE R_Module
    # 1 DLV
    common.Log In
...
WH14 RM
    common.Log In
    3.2 : Sort RM WIP1 -> WIP2 - คัดแยกวัตถุดิบ (RM) จาก WIP1 ไปยัง WIP2    ${data_excel.WH14_TH_CHANGE_3_2[RM]}
    8 : DLV (Delivery) - การส่งสินค้าออกจาก TMT Packing    ${data_excel.WH14_TH_DELIVERY_8[RM]}
