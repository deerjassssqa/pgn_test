...
WH12 RM
    common.Log In
    3.2 : Sort RM WIP1 -> WIP2 - คัดแยกวัตถุดิบ (RM) จาก WIP1 ไปยัง WIP2    ${data_excel.WH12_TH_CHANGE_3_2[RM]}
    4.2 : DLV with Barcode - การส่งสินค้าออกจาก TH W/H โดยใช้บาร์โค้ด    ${data_excel.WH12_TH_DELIVERY_4_2[RM]}
